...
<body>
    ...
    <h4 style="text-align: center;">Informe de soportes en Radio  <span style="font-weight:bold; color:turquoise ">{{$novedadopercance}}  </span></h4>
    @foreach ($informeradi as $informeradio)
