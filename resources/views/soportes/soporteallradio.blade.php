...
<body>
    ...
    <header>
        ...
        <h1 class="nombr">
            <strong>Reporte Soporte Técnico</strong>
        </h1>
    </header>
    ...
    @foreach ($informeradio as $informeradio)
        <table class="display table table-striped table-hover add-row nowrap">
            <tr>
                <th style="font-size: 30px;"> #{{ $informeradio->id }}</th>
            ...
            <tr>
                ...
                <td colspan="1">
                    ...
                    @elseif($informeradio->novedad->novedadopercance === 2)
                        <span class="badge badge-success">Retiro de Equipo</span>
                    @elseif($informeradio->novedad->novedadopercance === 3)
                        <span class="badge badge-success">Reinstalación</span>
                    @elseif($informeradio->novedad->novedadopercance === 4)
                        <span class="badge badge-success">Intermitente</span>
                    @elseif($informeradio->novedad->novedadopercance === 5)
                        <span class="badge badge-success">Lento</span>
                    @elseif($informeradio->novedad->novedadopercance === 6)
                        <span class="badge badge-success">Desconf. Router</span>
                    @elseif($informeradio->novedad->novedadopercance === 7)
                        <span class="badge badge-success">Cable. Dañado</span>
                    @elseif($informeradio->novedad->novedadopercance === 8)
                        <span class="badge badge-success">Problema de Equipos</span>
                    @elseif($informeradio->novedad->novedadopercance === 9)
                        <span class="badge badge-success">Sin servicio</span>
