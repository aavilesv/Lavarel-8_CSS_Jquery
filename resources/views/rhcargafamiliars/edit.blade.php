...
@section('title', 'Editar Carga Familiar')
@section('content')
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h1 class="text-white title-it"><i class="fas fa-home"></i> Editar Cargas Familiares</h1>
                ...
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                            ...
                            <form action="{{ route('rhcargafamiliar.update',$rrhcargafamiliar->id) }}" method="POST"
                                                ...
                                                <ol class="activity-feed">
                                                    <li class="feed-item feed-item-success">
                                                        <div class="row">
                                                            ...
                                                            <time class="date" datetime="9-25">Nombres-Apellidos</time>
                                                            <input type="text" name="nombre"
                                                                onKeyPress="return sololetrascoma(event)"
                                                                class="form-control input-border-bottom"
                                                                placeholder="Nombre: no requerido"
                                                                value="{{ old('nombre',$rrhcargafamiliar->nombre) }}">
                                                            @error('nombre')
                                                    ...
                                                    <li class="feed-item feed-item-primary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="parentezco"
                                                                ...
                                                                value="{{ old('parentezco',$rrhcargafamiliar->parentezco) }}">
                                                            @error('parentezco')
                                                                <div class="alert alert-danger" role="alert">
                                                                    <small>{{ $message }}</small>
                                                                </div>
                                                    ...
                                                    <li class="feed-item feed-item-primary">
                                                        <div class="row">
                                                            ...
                                                            <input type="date" name="fechanacimiento"
                                                                class="form-control input-border-bottom"
                                                                placeholder="Parantesco: no requerido"
                                                                value="{{ old('fechanacimiento',$rrhcargafamiliar->fechanacimiento) }}">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="chosen-select form-control roundss"
                                                                    ...
                                                                    data-placeholder="Empleado">
                                                                        <option value="{{ $rrhcargafamiliar->rrhempleado->id }}" >Seleccionado 
                                                                            {{ $rrhcargafamiliar->rrhempleado->nombre }}  {{ $rrhcargafamiliar->rrhempleado->apellido }}</option>
