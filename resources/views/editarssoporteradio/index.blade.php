    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h1 class="text-white title-it"><i class="fas fa-golf-ball"></i>EDITAR REPORTE DE RADIO
                    </h1>
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    ...
                    @if ($novedadopercance != '')
                        <a class="btn btn-primary btn-round ml-auto" data-toggle="tooltip"
                            ...
                            href="{{ route('pdffreporteradionovedad.soporteallgetoneradionovedad', $novedad) }}">
                            <i class="icon-printer"></i> Imprimir</a>
                    @elseif ($buscarincial === '')
                        <a class="btn btn-primary btn-round ml-auto" data-toggle="tooltip"
                            data-original-title="Imprimir todos los registros" target="_blank"
                            href="{{ route('pdffreporteradio.soporteallradio') }}">
                            <i class="icon-printer"></i> Imprimir</a>
                    @else <a class="btn btn-primary btn-round ml-auto" data-toggle="tooltip"
                            ...
                            href="{{ route('pdfffehcareporteradio.soporteallgetfecharadio', [$buscarincial, $buscarfinal]) }}">
                            <i class="icon-printer"></i> Imprimir</a>
                    @endif
                </div>
            </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="chosen-select form-control" name="novedadopercance"
                                                            ...
                                                            @if ($novedadopercance != '')
                                                                we
                                                                <option value="{{ $novedadopercance }}">Seleccionado
                                                                    :{{ $novedadopercance }}</option>
                                                            @else
                                                                <option value="" selected disabled hidden>Seleccione alguna
                                                                    Novedad</option>
                                                            @endif
                            ...
                            <div class="table-responsive">
                                <table id="add-row" cellspacing="0" width="100%"
                                    ...
                                    <tbody>
                                        @foreach ($soportefibraradioo as $fibr)
                                            <tr data-id="{{ $fibr->id }}">
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <a class="btn btn-link btn-primary btn-lg" data-toggle="tooltip"
                                                            ...
                                                            href="{{ route('editarreporteradio.edit', $fibr->id) }}"><i
                                                ...
                                                <td> {{ $fibr->novedad->cclicontratocliente->cliente->nombre }}-{{ $fibr->novedad->cclicontratocliente->cliente->apellido }}
                                                </td>
                                                <td>
                                                ...
                                                <td> {{ $fibr->novedad->cclicontratocliente->cliente->cedula }}
                                                </td>
                                                <td>{{ $fibr->fecha }}</td>
