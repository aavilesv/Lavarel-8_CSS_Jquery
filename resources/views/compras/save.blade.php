                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="chosen-select form-control list" id="pproveedor"
                                                    ...
                                                    @foreach ($proveedor as $proveedo)
                                                        <option value="{{ $proveedo->id }}"
                                                            data-cjson='{"nombre":"{{ $proveedo->nombres }}","telefono":"{{ $proveedo->telefono }}",
                                                                                        "direc":"{{ $proveedo->direccion }}","email":"{{ $proveedo->email }}"}'>
                                                            {{ $proveedo->cedula }} :
                                                            {{ $proveedo->nombres }} </option>
                                                    @endforeach
                                                    ...
                                                    <select class="chosen-select form-control list" id="cbarticulo"
                                                        ...
                                                        @foreach ($articulo as $articul)
                                                            <option value="{{ $articul->id }}"
                                                                data-ajson='{"id":"{{ $articul->id }}","precio":"{{ $articul->precio }}"
                                                                                ,"image":"{{ $articul->image }}","stock":"{{ $articul->sotck }}","cajanumero":"{{ $articul->cajanumero }}"
                                                                                ,"cajaunidad":"{{ $articul->cajaunidad }}"}'>
                                                                {{ $articul->marca->nombres }} ,
                                                                {{ $articul->nombres }} </option>
                                                        @endforeach
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-danger" id="cancelar"
                                                onclick="window.location='{{ route('compra.index') }}'">
            ...
            existe: function(item) {
                for (var i in this.compra.items) {
                    if (item.id == this.compra.items[i].id) {
                        ...
                        this.compra.items[i].cantidad = this.compra.items[i].cajanumero * this.compra.items[i]
                            .cajaunidad;
