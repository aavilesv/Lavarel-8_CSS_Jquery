...
@section('title', 'Editar Reporte de fibra')
@section('content')
    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h1 class="text-white title-it"><i class="icon-speedometer"></i> EDITAR REPORTE DE FIBRA
                                ...
                                <div class="form-button-action">
                                    <div class="row">
                                        ...
                                        @if ($novedadopercance != '' or $buscarincial != '')
                                            <div class="col-md-2">
                                                <a href="{{ route('editarreportefibra.index') }}" data-toggle="tooltip"
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a class="btn btn-link btn-info btn-lg" data-toggle="tooltip"
                                                            ...
                                                            href="{{ route('editarreportefibra.edit', $fibr->id) }}"><i
