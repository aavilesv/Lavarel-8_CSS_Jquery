...
<body>
    <header>
        ...
        <table class="display table table-striped table-hover add-row nowrap">
            <tr>
                <th><h1> #{{ $novedad->id }}</h1></th>
                <th colspan="4"> Novedad Registrada por: {{ $novedad->tecnico }}</th>
               </tr>
            <tr>
                <th> Cliente:</th>
                <td colspan="2">{{ $novedad->cclicontratocliente->cliente->nombre }}-{{ $novedad->cclicontratocliente->cliente->apellido }}</td>
            ...
            <tr>
                ...
                <td>
                    <a class="" data-toggle="tooltip"
                        ...
                        href="{{ $novedad->cclicontratocliente->gps }}"><i class="fas fa-external-link-alt"></i> Abrir
                        Ubicación</a>
                </td>
                <th>
                    Dirección:
