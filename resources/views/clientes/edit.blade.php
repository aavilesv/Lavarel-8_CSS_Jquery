...
<!--onsubmit="return todocedula()" -->
                            <form action="{{ route('clientes.update', $cliente) }}" method="POST" class="form-control form-createe" enctype="multipart/form-data">
                                                    ...
                                                    <li class="feed-item feed-item-success">
                                                        <div class="row">
                                                            ...
                                                            <select class="chosen-select form-control" name="estadocivil"
                                                                data-placeholder="Sucursal">
                                                                <option value="{{ $cliente->estadocivil }}">   @if ($cliente->estadocivil === 1)
                                                    ...
                                                    <li class="feed-item feed-item-success">
                                                        <div class="row">
                                                            ...
                                                            <input type="file" name="ffoto" accept="image/*"
                                                                ...
                                                                value="{{ old('ffoto') }}">
                                                                <input type="text" value="{{ $cliente->ffoto }}">
                                                            @error('ffoto')
                                                                <div class="alert alert-danger" role="alert">
                                                                    <small>{{ $message }}</small>
                                                                </div>
