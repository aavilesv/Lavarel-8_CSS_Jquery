...
<head>
    <meta charset="UTF-8">
    <title>Pdf Asistencia  diaria</title>
...
<body>
    ...
    <header>
        ...
        <h1 class="nombr">
            <strong><i class="fas fa-wrench"></i> Asistencia registradas Diaria</strong>
        </h1>

    </header>
    <div class="">
        <h4 style="text-align: center;">Registro de Asistencia por fecha</h4>
        <h5 style="text-align: center;"><small> Fecha {{ $id }}</small></h5>
