                ...
                <div class="col-md-12">
                    <div class="card full-height">
                        <div class="card-body">
                            ...
                            @if ($buscarincial != '')  
                            <br>
                            <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Refrescar" href="{{ route('asistencianocumplidas.index') }}"><i class="fa fa-plus"></i> Recargar pagina</a>
                            @endif
