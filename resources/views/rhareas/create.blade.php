        ...
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    ...
                    <h1 class="text-white title-it"><i class="fas fa-globe"></i> Crear Área</h1>
                ...
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                            <form action="{{ route('rhareas.store') }}" method="POST" class="form-control">
                                @csrf
                                <div class="form-group">
                                    <label for="nombre">Nombre:</label>
                                    <input type="text" name="nombre" onKeyPress="return sololetrascoma(event)"
                                        class="form-control roundss" placeholder="Nombre" value="{{ old('nombre') }}">
                                    @error('nombre')
