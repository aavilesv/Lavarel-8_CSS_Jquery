                                ...
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        ...
                                        <input type="date" required name="fechainicial" id="min"
                                            placeholder="Search ..." value="{{ old('fechainicial') }}">
                                    </li>
                                    <li class="list-inline-item">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('cuentasporcobrar.destroy', 0) }}" class="form-createe">
                        <div class="row">
                            @csrf
                            @method('delete')
    ...
    $('#min, #max').on('change', function () {
        table.draw();
         ...
         table = $('.add-rowww').DataTable({
            ...
            "pageLength": 10,
            "destroy": true,
            "ajax": "{{ route('datablecuentas.listarcuentacobrar') }}",
            "data": {
                "opselect": "opselect"
            },
            "type": 'get',
