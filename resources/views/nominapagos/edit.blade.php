...
@section('title', 'Editar de Nominas de Pago')
@section('content')
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h1 class="text-white title-it"><i class="flaticon-agenda-1"></i> Editar Nomina de Pago</h1>
        ...
        <div class="row mt--2">
            <div class="col-md-12">
                <div class="card full-height">
                    <div class="card-body">
                        <div class="card-title"><i class="far fa-list-alt"></i> Editar Pago</div>
                        <div class="card-category"><i class="fab fa-creative-commons-nd"></i> Roles de pagos de Empleados
                            Registrados</div>
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                            <form 
                            action="{{ route('nominapago.update', $nominas) }}"
                          method="POST"
                                    ...
                                    <div class="card full-height">
                                        <div class="card-header">
                                            <div class="card-title">
                                                <i class="fas fa-pen-alt"></i> Datos
                                            </div>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select
                                                                ...
                                                                <option value=" {{$nominas->rrhempleado->id }}">Seleccionado
                                                                    {{$nominas->rrhempleado->nombre }} {{$nominas->rrhempleado->apellido }} {{$nominas->rrhempleado->cedula }}</option>
                                                ...
                                                <li class="feed-item feed-item-secondary">
                                                    <div class="row">
                                                        ...
                                                        <input type="text" id="cnombre"
                                                            ...
                                                            value="{{ old('archivo',$nominas->rrhempleado->nombre) }}">
                                                    </div>
                                                </li>
                                                <li class="feed-item feed-item-success">
                                                    <div class="row">
                                                        ...
                                                        <input type="text" id="capellido"
                                                            class="form-control input-border-bottom"
                                                            placeholder="Descirpción: requerido"
                                                            value="{{ old('archivo',$nominas->rrhempleado->apellido) }}"
                                                            >
                                                    </div>
                                                </li>
                                                ...
                                                <li class="feed-item feed-item-secondary">
                                                    <div class="row">
                                                        ...
                                                        <input type="text" id="ccedula"
                                                            class="form-control input-border-bottom"
                                                            placeholder="Descirpción: requerido"
                                                            value="{{ old('archivo',$nominas->rrhempleado->cedula) }}">
                                                    </div>
                                                </li>
                                                ...
                                                <li class="feed-item feed-item-success">
                                                    <div class="row">
                                                        ...
                                                        <input type="file" name="archivo"
                                                            ...
                                                            value="{{ old('archivo',$nominas->archivo) }}">
                                                        @error('archivo')
                                                            <div class="alert alert-danger" role="alert">
                                                                <small>{{ $message }}</small>
                                                            </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group form-inline">
                                                    ...
                                                    <div class="col-md-9 p-0">
                                                        ...
                                                        value="{{ old('dialaborales',$nominas->dialaborales) }}"
                                                    ...
                                                    <li class="feed-item feed-item-success">
                                                        <div class="row">
                                                            ...
                                                            onKeyPress="return soloNumerospunto(event)"
                                                                ...
                                                                value="{{ old('sueldo',$nominas->sueldo) }}">
                                                            @error('sueldo')
                                                                <div class="alert alert-danger" role="alert">
                                                                    <small>{{ $message }}</small>
                                                                </div>
                                                    ...
                                                    <li class="feed-item feed-item-primary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="horasextras"
                                                                ...
                                                                onKeyPress="return soloNumerospunto(event)"
                                                                value="{{ old('horasextras',$nominas->horasextras) }}">
                                                            @error('horasextras')
                                                                <div class="alert alert-danger" role="alert">
                                                                    <small>{{ $message }}</small>
                                                                </div>
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="comisiones"
                                                                ...
                                                                value="{{ old('comisiones',$nominas->comisiones) }}"
                                                                onKeyPress="return soloNumerospunto(event)"
                                                                maxlength="10">
                                                            @error('comisiones')
                                                                <div class="alert alert-danger" role="alert">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="liquido"
                                                                class="form-control input-border-bottom"
                                                                placeholder="liquido"
                                                                value="{{ old('liquido',$nominas->liquido) }}"
                                                                onKeyPress="return soloNumerospunto(event)"
                                                                maxlength="10">
                                                            @error('liquido')
                                                                <div class="alert alert-danger" role="alert">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="prestamosquirogramaiess"
                                                                ...
                                                                value="{{ old('prestamosquirogramaiess',$nominas->prestamosquirogramaiess) }}">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="descuentosinternet"
                                                                ...
                                                                value="{{ old('descuentosinternet',$nominas->descuentosinternet) }}"
                                                                onKeyPress="return soloNumerospunto(event)" 
                                                                maxlength="10">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="aporteiess"
                                                                ...
                                                                value="{{ old('aporteiess',$nominas->aporteiess) }}"
                                                                onKeyPress="return soloNumerospunto(event)" 
                                                                maxlength="10">
                                                            @error('aporteiess')
                                                                <div class="alert alert-danger" role="alert">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="prestamosyanticipos"
                                                                ...
                                                                value="{{ old('prestamosyanticipos',$nominas->prestamosyanticipos) }}"
                                                                onKeyPress="return soloNumerospunto(event)" 
                                                                maxlength="10">
                                                    ...
                                                    <li class="feed-item feed-item-secondary">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" name="totaldescuentos"
                                                                ...
                                                                value="{{ old('totaldescuentos',$nominas->totaldescuentos) }}"
                                                                onKeyPress="return soloNumerospunto(event)" 
                                                                maxlength="10">
