...
<body>
    ...
    <h4 style="text-align: center;">Informe de soportes en fibra  
        <span style="font-weight:bold; color:turquoise "><?php echo e($novedadopercance); ?>  </span></h4>
    <?php $__currentLoopData = $informefibr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $informefibra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <table class="display table table-striped table-hover add-row nowrap">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    -<?php echo e($informefibra->novedad->cclicontratocliente->contratocodigo); ?>
            ...
            <tr>
                ...
                <td><?php echo e($informefibra->novedad->cclicontratocliente->canton->provincia->name); ?>-<?php echo e($informefibra->novedad->cclicontratocliente->canton->name); ?>
...
<?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/soportes/soportepdfgetnovedadfibra.blade.php ENDPATH**/ ?>