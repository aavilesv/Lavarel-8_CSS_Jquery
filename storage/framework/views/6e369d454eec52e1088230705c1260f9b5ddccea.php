            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        ...
                        href="<?php echo e(route('contratoclientes.create')); ?>"><i class="fa fa-plus"></i> Ingresar</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <table class="display table table-striped table-hover nowrap" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo e($rrhprofesion->contratocodigo); ?></td>
                                              <td><?php echo e($rrhprofesion->cclicontratotipocliente->descripcion); ?></td>
                                              ...
                                              <td> <?php echo e(date("d F Y", strtotime($rrhprofesion->created_at))); ?><?php echo e($rrhprofesion->created_at); ?></td>
                                              <td>
                                                <a class="btn btn-link btn-primary btn-lg" target="_blank" data-toggle="tooltip"
                                                data-original-title="Ver" 
                                               href="<?php echo e(asset($rrhprofesion->archivo)); ?>"><i class="fas fa-file-alt"></i></a>
                                               </td>
                                               <td>
                                                <?php if($rrhprofesion->eliminar === 1): ?>
                                              ...
                                              <td>
                                                ...
                                                href="<?php echo e(route('contratoclientes.show',$rrhprofesion->id)); ?>"><i class="fa fa-eye"></i></a>
                                                    <a class="btn btn-link btn-primary btn-lg" data-toggle="tooltip"
                                                     data-original-title="Editar" 
                                                    href="<?php echo e(route('contratoclientes.edit',$rrhprofesion->id)); ?>"><i class="fa fa-edit"></i></a>
                                                      
                                                <a class="btn btn-link btn-warning btn-eliminar" 
                                                data-toggle="tooltip" data-original-title="Anular Contrato"
                                                data-json='{"id":"<?php echo e($rrhprofesion->id); ?>"}' 
                                                rel="action"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST" action="<?php echo e(route('contratoclientes.destroy',0)); ?>">
                                                    <div class="row">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/cclicontratoclientes/index.blade.php ENDPATH**/ ?>