                                ...
                                <div class="card full-height">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <time class="date" datetime="9-25">Dinero entrago al gerente al final del
                                                    día:</time>
                                                <input type="text" id="fechadeposito" name="fechadeposito"
                                                    class="form-control input-border-bottom"
                                            ...
                                            <div class="col-md-3">
                                                <time class="date" datetime="9-25">Total en caja sin restar
                                                    gerencia</time>
                                                <input type="text" id="fechadeposito" name="fechadeposito"
                                                    class="form-control input-border-bottom"
                            ...
                            <div class="form-control">
                                <div class="card full-height">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                class="table table-striped table-hover table-head-bg-info table-bordered-bd-info mt-4 add-row display nowrap">
                                                <thead>
                                                    <tr>
                                                        <th>Nombre</th>
                                                        <th>Descripción</th>
