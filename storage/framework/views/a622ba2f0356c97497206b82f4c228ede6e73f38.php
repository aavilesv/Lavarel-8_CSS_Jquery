                ...
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                            <form action="<?php echo e(route('rrhasistencias.store')); ?>" id="miForm" name="form_reloj"
                                                    ...
                                                    <ol class="activity-feed">
                                                        <li class="feed-item feed-item-success">
                                                            <div class="row">
                                                                ...
                                                                <?php if($message = Session::get('cedula')): ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/rrhasistencias/index.blade.php ENDPATH**/ ?>