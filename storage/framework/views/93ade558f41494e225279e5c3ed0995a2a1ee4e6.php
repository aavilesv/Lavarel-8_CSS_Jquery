                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $novedads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $novedad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ><i class="fas fa-times"></i></a>
                                                ...
                                                <td><?php echo e($novedad->cclicontratocliente->cliente->nombre); ?> <?php echo e($novedad->cclicontratocliente->cliente->apellido); ?>

                                                <?php echo e($novedad->cclicontratocliente->contratocodigo); ?></td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="<?php echo e(route('novedadupdatecontroller.destroy',0)); ?>">
                                                <div class="row">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/novedads/index.blade.php ENDPATH**/ ?>