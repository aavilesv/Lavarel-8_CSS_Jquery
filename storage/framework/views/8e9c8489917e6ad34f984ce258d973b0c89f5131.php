            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <a class="btn btn-primary btn-round ml-auto" data-toggle="tooltip"
                        ...
                        href="<?php echo e(route('pdfclieente.clientespdfall')); ?>"><i class="icon-printer"></i> Imprimir</a>
                    <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Ver"
                        href="<?php echo e(route('clientes.create')); ?>"><i class="fa fa-plus"></i> Ingresar</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                            ...
                            <div class="container">
                                ...
                                <div class="form-button-action">
                                    <div class="row">
                                        <div    <?php if($buscador != ''): ?> class="col-md-10"  <?php else: ?> class="col-md-12"  <?php endif; ?>>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr data-id="<?php echo e($cliente->id); ?>">
                                                ...
                                                <td>
                                                    <center> <a href="<?php echo e(asset($cliente->fotocedula2)); ?>"
                                                            data-lightbox="mygallery"
                                                            data-title="<?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?>">
                                                            <img src="<?php echo e(asset($cliente->fotocedula2)); ?>" title="ver imagen"
                                                                class="img-fluid center" alt="Responsive image"
                                                                style="width:100px; height:100px;"></a> </center>
                                                </td>
                                                <td>
                                                    <center> <a href="<?php echo e(asset($cliente->ffoto)); ?>"
                                                            data-lightbox="mygallery"
                                                            data-title="<?php echo e($cliente->nombre); ?> <?php echo e($cliente->apellido); ?>">
                                                            <img src="<?php echo e(asset($cliente->ffoto)); ?>" title="ver imagen"
                                                                class="img-fluid center" alt="Responsive image"
                                                                style="width:100px; height:100px;"></a> </center>
                                                </td>
...
<?php echo e($clientes->appends(['buscador' => $buscador])->links()); ?>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="<?php echo e(route('clientes.destroy', 0)); ?>">
                                                <div class="row">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\AppQuantika\resources\views/clientes/index.blade.php ENDPATH**/ ?>