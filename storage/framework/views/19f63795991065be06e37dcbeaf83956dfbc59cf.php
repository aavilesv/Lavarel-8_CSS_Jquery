...
<?php $__env->startSection('title', 'Listado de Planes'); ?>
            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Ingresar"
                        href="<?php echo e(route('planes.create')); ?>"><i class="fa fa-plus"></i> Planes</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="tab-pane fade show active" id="pills-home-nobd" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="basic-datatables" class="display table table-striped table-hover add-row">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $plant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($plan->id); ?>">
                                                    ...
                                                    <td>$<?php echo e($plan->valor); ?></td>
                                                    <td>
                                                        <?php if($plan->status === 1): ?>
                                                            <span class="badge badge-success">Radio</span>
                                                        <?php else: ?>
                                                            <span class="badge badge-warning">Fibra</span>
                                                        <?php endif; ?>
                                                    </td>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/pageplanes/index.blade.php ENDPATH**/ ?>