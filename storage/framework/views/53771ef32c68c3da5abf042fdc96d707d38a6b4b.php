            ...
            <div class="card full-height">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-around pb-2 pt-4">
                        <form action="<?php echo e(route('cuentasporcobrar.store')); ?>" method="POST"
                                                                    ...
                                                                    <?php $__currentLoopData = $contratocliente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($cliente->id); ?>"
                                                                            data-cjson='{"cedula":"<?php echo e($cliente->cliente->cedula); ?>"
                                                                                                    ,"modalidadequipo":"<?php echo e($cliente->modalidadequipo); ?>"  
                                                                                                    ,"tipodeservicio":"<?php echo e($cliente->tipodeservicio); ?>"
                                                                                                    ,"comportacion":"<?php echo e($cliente->comportacion); ?>"
                                                                                                    ,"tarifa":"<?php echo e($cliente->tarifa); ?>"
                                                                                                    ,"fecha":"<?php echo e($cliente->fecha); ?>" ,"email":"<?php echo e($cliente->cliente->email); ?>","anchodebanda":"<?php echo e($cliente->anchodebanda); ?>","servicio":
                                                                                                    <?php if($cliente->servicio == 1): ?> "Radio" <?php else: ?> "Fibra" <?php endif; ?>,"apellido":"<?php echo e($cliente->cliente->apellido); ?>","nombre":"<?php echo e($cliente->cliente->nombre); ?>"}'>
                                                                            <?php echo e($cliente->cliente->nombre); ?>

                                                                            <?php echo e($cliente->cliente->apellido); ?> :
                                                                            <?php echo e($cliente->cliente->cedula); ?>
...
<script>
    ...
    function tablecargar() {
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo e(route('mostrarclientecobrar.index')); ?>',
            data: {
    ...
    function buttoncobrar(number, saldo) {
        swal({
            ...
            if (willDelete) {
                ...
                $.ajax({
                    type: "GET",
                    url: '<?php echo e(route('mostrarclientecobrar.create')); ?>',
                    data: {
                        id: number,
                        saldo: saldo
                    },
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/cuentasporcobrars/save.blade.php ENDPATH**/ ?>