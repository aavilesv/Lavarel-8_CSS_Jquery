            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    ...
                    <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Ingresar"
                        href="<?php echo e(route('listarcobrocorte.create')); ?>"><i class="fa fa-plus"></i> Ingresar</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="table-responsive">
                                <table id="add-row" cellspacing="0" width="100%"
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $listadocobro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr data-id="<?php echo e($listado->id); ?>">
                                                <td><?php echo e($listado->id); ?></td>
                                                <td>
                                                    <center> <a href="<?php echo e(asset($listado->cclicontratocliente->cliente->ffoto)); ?>"
                                                            data-lightbox="mygallery"
                                                            data-title="<?php echo e($listado->nombre); ?> <?php echo e($listado->apellido); ?>">
                                                            <img src="<?php echo e(asset($listado->cclicontratocliente->cliente->ffoto)); ?>" title="ver imagen"
                                                                class="img-fluid center" alt="Responsive image"
                                                                style="width:100px; height:100px;"></a> </center>
                                                </td>

                                                <td><?php echo e($listado->cclicontratocliente->cliente->nombre); ?> <?php echo e($listado->cclicontratocliente->cliente->apellido); ?></td>
                                                <td>$<?php echo e($listado->cclicontratocliente->tarifa); ?></td>
                                                <td><?php echo e($listado->fechanacimiento); ?></td>
                                                <td><?php echo e($listado->contacto); ?></td>
                                                <td><?php echo e($listado->contacto1); ?></td>
                                                <td><?php echo e($listado->cdaorecinto); ?></td>
                                                <td><?php echo e($listado->email); ?></td>
                                                <td><?php echo e($listado->direccion); ?></td>
                                                <td><?php echo e($listado->licencia); ?></td>
                                                
                                                <td>
                                                    <?php if($listado->estado === 1): ?>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-button-action">
                                                        ...
                                                        <a class="btn btn-link btn-info btn-lg" data-toggle="tooltip"
                                                            ...
                                                            href="<?php echo e(route('pdfempleado.empleadospdfgetone', $listado->id)); ?>"><i
                                                                class="icon-printer"></i></a>
                              
                                                        <a class="btn btn-link btn-primary btn-lg" data-toggle="tooltip"
                                                            data-original-title="Editar"
                                                            href="<?php echo e(route('rhempleados.edit', $listado->id)); ?>"><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/listarcobrocorte/index.blade.php ENDPATH**/ ?>