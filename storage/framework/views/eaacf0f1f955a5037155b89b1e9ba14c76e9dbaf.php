            ...
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                ...
                <div class="ml-md-auto py-2 py-md-0">
                    <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Ingresar"
                        href="<?php echo e(route('quiensomos.create')); ?>"><i class="fa fa-plus"></i> Quienes somos</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="tab-pane fade show active" id="pills-home-nobd" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table id="basic-datatables" class="display table table-striped table-hover add-row">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $quensomo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr data-id="<?php echo e($plan->id); ?>">
                                                    ...
                                                    <td><?php echo e($plan->mision); ?></td>
                                                    <td><?php echo e($plan->vision); ?></td>
                                                    ...
                                                    <td><?php echo e($plan->objetivos); ?></td>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/pagequiensomos/index.blade.php ENDPATH**/ ?>