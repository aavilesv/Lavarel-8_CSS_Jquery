                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a class="btn btn-link btn-primary btn-lg" data-toggle="tooltip"
                                                                ...
                                                                href="<?php echo e(route('promocion.edit', $promocion->id)); ?>"><i
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $promocioncliente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promocion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr data-id="<?php echo e($promocion->id); ?>">
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a class="btn btn-link btn-warning btn-eliminar"
                                                                ...
                                                                data-json='{"id":"<?php echo e($promocion->id); ?>","action":"cliente"}'
                                                                rel="action"><i class="fas fa-times"></i></a>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td><?php echo e($promocion->cclicontratocliente->cliente->nombre); ?>

                                                        <?php echo e($promocion->cclicontratocliente->cliente->apellido); ?></td>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/promocions/index.blade.php ENDPATH**/ ?>