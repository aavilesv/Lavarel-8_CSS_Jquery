                ...
                <div class="ml-md-auto py-2 py-md-0">
                    ...
                    <?php if($novedadopercance != ''): ?>
                        <a class="btn btn-primary btn-round ml-auto" data-toggle="tooltip"
                            ...
                            href="<?php echo e(route('pdffreportefibranovedad.soportegetonefibranovedad',$novedad)); ?>">
                            ...
                            <div class="table-responsive">
                                <table id="add-row" cellspacing="0" width="100%"
                                    ...
                                    <tbody>
                                        ...
                                        <?php if($numeropercance  == $fibr->novedad->novedadopercance ): ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\AppQuantika\resources\views/soportes/informefibra.blade.php ENDPATH**/ ?>