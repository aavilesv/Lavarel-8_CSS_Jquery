                                ...
                                <div class="card full-height">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <button onclick="myFunction('<?php echo e(route('gerente.edit',  $cajaa->id )); ?>')"
                                                        ...
                                                        <i class="fas fa-calendar-minus"> Entrar dinero al Gerente</i>
                                                    </button>
                                                </div>
                                                <div class="col-md-4" style="font-weight: bold; font-size: 23px;">
                                                    Fecha de Hoy: <?php echo e($cajaa->fecha); ?>
                            ...
                            <div class="form-control">
                                <div class="card full-height">
                                    ...
                                    <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <button onclick="myFunction('<?php echo e(route('diariacobro.edit',  $cajaa->id )); ?>')"
                                                            href="#mdsucur" rel="action"
                                                            data-toggle="modal" title="Ingresar" data-backdrop="static" data-keyboard="false"
                                                            class="btn btn-success btn-border btn-round ml-auto">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\AppQuantika\resources\views/cobro/index.blade.php ENDPATH**/ ?>