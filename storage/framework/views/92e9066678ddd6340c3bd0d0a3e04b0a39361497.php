        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white title-it"><i class="flaticon-time"></i> Reporte de no haber
                             terminado jornada laboral 7:30 h/m</h1>
                ...
                <div class="col-md-12">
                    <div class="card full-height">
                        <div class="card-body">
                            ...
                            <?php if($buscarincial != ''): ?>  
                            <br>
                            <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Refrescar" href="<?php echo e(route('asistencianocumplidas.index')); ?>"><i class="fa fa-plus"></i> Recargar pagina</a>
                            <?php endif; ?>
