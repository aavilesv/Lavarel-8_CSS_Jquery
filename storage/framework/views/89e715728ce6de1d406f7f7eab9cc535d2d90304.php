                        ...
                        <div class="d-flex flex-wrap justify-content-around pb-2 pt-4" style="font-weight: bold;">
                            ...
                            <div class="table-responsive">
                                ...
                                <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Ver"
                                    href="<?php echo e(route('reportedit.edit',  $cajaa->id )); ?>"><i class="fa fa-plus"></i> Ingresar Cobro  a Clientes</a>
                                <table id=""
                            ...
                            <div class="form-control">
                                <div class="card full-height">
                                    ...
                                    <div class="card-body">
                                        <a class="btn btn-success btn-round ml-auto" data-toggle="tooltip" data-original-title="Ver"
                                    href="<?php echo e(route('cobroextra.show',  $cajaa->id )); ?>"><i class="fa fa-plus"></i> Ingresar Cobros extras</a>
                                                <div class="table-responsive">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AppQuantika\resources\views/cajareporte/show.blade.php ENDPATH**/ ?>